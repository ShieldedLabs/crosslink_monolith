...
fn adjust_difficulty_and_time_for_testnet(
    ...
    //
    // Zebra used to do this, switching 2 * PoWTargetSpacing early, via a former
    // `EXTRA_TIME_TO_MINE_A_BLOCK` constant. On a chain with any sustained hashrate, that
    // behaviour produced a stream of future-dated minimum-difficulty blocks, each of which
