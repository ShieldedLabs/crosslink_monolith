...
impl Chain {
    ...
    fn update_chain_tip_with_block_except_trees(
            ...
            .enumerate()
        {
            let (
                ...
                // Crosslink carries the v6 body, so its bundles have the same shapes as V6.
                VCrosslink {
                    inputs,
                    outputs,
                    sapling_shielded_data,
    ...
    // Correct regardless of how far the slash index has advanced: heights the index
    // hasn't reached are replayed here, from this chain or the finalized db. The
